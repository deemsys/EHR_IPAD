...

{
    ...
    NSString *whitelabel,*genderlabel,*nourishedlabel,*fairlabel,*normallabel,*poorlabel,*pathollabel,*cerviclabel,*cervicanotherlabel,*lrlabel,*lrtrapezius,*lranother;
    NSArray *hypoarray;
}
...
@property (retain, nonatomic) IBOutlet UITextField *degree;
...
@property (retain, nonatomic) IBOutlet UILabel *shelabel;
