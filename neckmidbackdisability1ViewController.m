//
//  neckmidbackdisability1ViewController.m
...
@interface neckmidbackdisability1ViewController ()

@end

@implementation neckmidbackdisability1ViewController
...
- (IBAction)next:(id)sender {
    ...
    if (c==1) {
        ...
        [self performSegueWithIdentifier:@"neckback2" sender:self];
    }
}
- (BOOL)shouldPerformSegueWithIdentifier:(NSString *)identifier sender:(id)sender
{
    ...
    if([identifier isEqual:@"neckback2"])
    {
        if (c==1)
        {
            return YES;
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([segue.identifier isEqualToString:@"neckback2"])
    {
        
        neckmidbackdisability2ViewController *destViewController = [segue destinationViewController];
        destViewController.recorddict=recorddict;
        NSLog(@"recorddict in neck back second %@",recorddict);
    }
